...
class Screen : public Hardware, public MemoryRegion {
public:
	Screen (VirtualMachine *VM);
	~Screen ();
	...
	void draw_glyph (uint8_t, uint32_t, uint32_t, uint8_t);
	void putpixel (uint32_t, uint32_t, uint8_t);
